...
//esta anotación hace a esta clase transversal a otras cuando la marquen con excepciones
@ControllerAdvice 	
@RestController
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
	...
	//Escribimos algunos métodos para centralizar
	//le decimos que este método solo sea invocado cuando encuentre anotaciones del tipo
